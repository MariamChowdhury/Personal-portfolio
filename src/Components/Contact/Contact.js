...
const Contact = () => {
  function sendEmail(e) {
    ...
    emailjs.sendForm('service_xxnl46y','template_4118hsk', e.target,'user_gErDNv6c3u1jdrinz6jh9')
      .then((result) => {
      ...
      <div className="row mt-5">
        <div className="col-md-6 mx-auto mt-5">
          ...
          >
            ...
            <div class="form-class form-text container px-5 pt-4">
              <input
                type="subject"
                class="form-control"
                name="name"
            ...
            <div className="container px-5">
              <div className="row">
              <button type="submit" value='send' class="btn btn-color mt-2 mb-4">
                Submit
              </button>
              </div>
            </div>
