  ...
  const data = [
    {
      ...
      title:
        "JavaScript is a light weighted, interpreted, a compiled programming language that...",
    },
    {
      ...
      title:
        "React is known as javascript’s library for user interfaces. The point to be noted here is that react is a “library,” not a...",
    },
    {
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="mt-5 text-center">
            <Link to="/blog">
              <button type="button" className="btn btn-color mb-5">
